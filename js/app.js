...
import { t, getLang, setLang, applyStatic } from './i18n.js?v=20260906b';
import { initGrid, hasGrid, meta as gridMeta, cells as gridCells, available as gridAttrs, show as showGrid, hide as hideGrid, fmt as gridFmt, setExtrude as setGridExtrude, ATTRS as GRID_ATTRS } from './grid.js?v=20260906b';
...
async function openSimulator() {
  ...
  try {
    if (!_simMod) {
      _simMod = await import('./sim.js?v=20260906b');
      _simMod.initSim({
...
function initPWA() {
  if ('serviceWorker' in navigator) navigator.serviceWorker.register('sw.js?v=20260906b').catch(() => {});
...
let _regionMod = null;
const regionMod = () => _regionMod || (_regionMod = import('./region.js?v=20260906b'));
